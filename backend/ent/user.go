...
type User struct {
	...
	// AdminMenuPermissions holds the value of the "admin_menu_permissions" field.
	AdminMenuPermissions string `json:"admin_menu_permissions,omitempty"`
	...
	// AllowBalanceSubscriptionPurchase holds the value of the "allow_balance_subscription_purchase" field.
	AllowBalanceSubscriptionPurchase bool `json:"allow_balance_subscription_purchase,omitempty"`
	// HelpCenterKeyPromptDismissed holds the value of the "help_center_key_prompt_dismissed" field.
	HelpCenterKeyPromptDismissed bool `json:"help_center_key_prompt_dismissed,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldTotpEnabled, user.FieldBalanceNotifyEnabled, user.FieldAllowBalanceSubscriptionPurchase, user.FieldHelpCenterKeyPromptDismissed:
			values[i] = new(sql.NullBool)
		case user.FieldBalance, user.FieldBalanceNotifyThreshold, user.FieldTotalRecharged:
			values[i] = new(sql.NullFloat64)
		case user.FieldID, user.FieldConcurrency, user.FieldRpmLimit:
			values[i] = new(sql.NullInt64)
		case user.FieldEmail, user.FieldPasswordHash, user.FieldRole, user.FieldAdminMenuPermissions, user.FieldStatus, user.FieldUsername, user.FieldNotes, user.FieldTotpSecretEncrypted, user.FieldSignupSource, user.FieldBalanceNotifyThresholdType, user.FieldBalanceNotifyExtraEmails:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldAdminMenuPermissions:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field admin_menu_permissions", values[i])
			} else if value.Valid {
				_m.AdminMenuPermissions = value.String
			}
		...
		case user.FieldAllowBalanceSubscriptionPurchase:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field allow_balance_subscription_purchase", values[i])
			} else if value.Valid {
				_m.AllowBalanceSubscriptionPurchase = value.Bool
			}
		case user.FieldHelpCenterKeyPromptDismissed:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field help_center_key_prompt_dismissed", values[i])
			} else if value.Valid {
				_m.HelpCenterKeyPromptDismissed = value.Bool
			}
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("admin_menu_permissions=")
	builder.WriteString(_m.AdminMenuPermissions)
	builder.WriteString(", ")
	...
	builder.WriteString(", ")
	builder.WriteString("allow_balance_subscription_purchase=")
	builder.WriteString(fmt.Sprintf("%v", _m.AllowBalanceSubscriptionPurchase))
	builder.WriteString(", ")
	builder.WriteString("help_center_key_prompt_dismissed=")
	builder.WriteString(fmt.Sprintf("%v", _m.HelpCenterKeyPromptDismissed))
	builder.WriteString(", ")
