...
var (
	...
	SubscriptionPlansColumns = []*schema.Column{
		...
		{Name: "limited_offer_price", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,2)"}},
		{Name: "limited_offer_expires_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "validity_days", Type: field.TypeInt, Default: 30},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "admin_menu_permissions", Type: field.TypeString, Default: "[]", SchemaType: map[string]string{"postgres": "text"}},
		...
		{Name: "allow_balance_subscription_purchase", Type: field.TypeBool, Default: false},
		{Name: "help_center_key_prompt_dismissed", Type: field.TypeBool, Default: false},
		{Name: "rpm_limit", Type: field.TypeInt, Default: 0},
	}
