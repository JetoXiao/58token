...
func init() {
	...
	// userDescAdminMenuPermissions is the schema descriptor for admin_menu_permissions field.
	userDescAdminMenuPermissions := userFields[3].Descriptor()
	// user.DefaultAdminMenuPermissions holds the default value on creation for the admin_menu_permissions field.
	user.DefaultAdminMenuPermissions = userDescAdminMenuPermissions.Default.(string)
	...
	// userDescAllowBalanceSubscriptionPurchase is the schema descriptor for allow_balance_subscription_purchase field.
