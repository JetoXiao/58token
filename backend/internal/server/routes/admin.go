...
func RegisterAdminRoutes(
	...
	admin.Use(middleware.SubAdminAdminPermissionGuard())
	{
		// 仪表盘
...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.GET("/balance-deductions", h.Admin.Dashboard.GetDailyBalanceDeductions)
		dashboard.GET("/user-usage-hierarchy", h.Admin.Dashboard.GetUserUsageHierarchy)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.PUT("/sort-order", h.Admin.Account.UpdateSortOrder)
		...
		accounts.POST("/upstream-pricing/groups", h.Admin.Account.PreviewUpstreamPricingGroups)
		accounts.GET("/:id/upstream-pricing", h.Admin.Account.GetUpstreamPricing)
