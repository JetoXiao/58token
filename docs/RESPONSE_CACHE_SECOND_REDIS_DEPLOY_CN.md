...
```yaml
      ...
      - RESPONSE_CACHE_RECOMMENDATION_MIN_UNIQUE_KEYS=${RESPONSE_CACHE_RECOMMENDATION_MIN_UNIQUE_KEYS:-20}
      - RESPONSE_CACHE_RECOMMENDATION_TOP1_MAX_HIT_SHARE=${RESPONSE_CACHE_RECOMMENDATION_TOP1_MAX_HIT_SHARE:-0.50}
      - RESPONSE_CACHE_RECOMMENDATION_TOP5_MAX_HIT_SHARE=${RESPONSE_CACHE_RECOMMENDATION_TOP5_MAX_HIT_SHARE:-0.80}
```
