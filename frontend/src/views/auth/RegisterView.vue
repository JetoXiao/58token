  ...
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div
        ...
        class="rounded-xl border border-accent-200 bg-accent-50 p-4 dark:border-accent-800/40 dark:bg-accent-900/20"
      >
        <div class="flex items-start gap-3">
          <div class="flex-shrink-0">
            <Icon name="exclamationCircle" size="md" class="text-accent-500" />
          </div>
      ...
      <form v-else @submit.prevent="handleRegister" class="space-y-5">
        ...
        <div v-if="emailVerifyEnabled">
          ...
          <transition name="fade">
            <div
              v-if="codeSent"
              class="mt-2 flex items-center gap-2 rounded-lg bg-primary-50 px-3 py-2 dark:bg-primary-900/20"
            >
              <Icon name="checkCircle" size="sm" class="text-primary-600 dark:text-primary-400" />
        ...
        <div v-if="invitationCodeEnabled">
          ...
          <transition name="fade">
            <div v-if="invitationValidation.valid" class="mt-2 flex items-center gap-2 rounded-lg bg-primary-50 px-3 py-2 dark:bg-primary-900/20">
              <Icon name="checkCircle" size="sm" class="text-primary-600 dark:text-primary-400" />
              <span class="text-sm text-primary-700 dark:text-primary-300">
        ...
        <div v-if="promoCodeEnabled">
          ...
          <transition name="fade">
            <div v-if="promoValidation.valid" class="mt-2 flex items-center gap-2 rounded-lg bg-primary-50 px-3 py-2 dark:bg-primary-900/20">
              <Icon name="gift" size="sm" class="text-primary-600 dark:text-primary-400" />
              <span class="text-sm text-primary-700 dark:text-primary-300">
...
const siteName = ref<string>('58Token')
...
onMounted(async () => {
  ...
  try {
    ...
    siteName.value = settings.site_name || '58Token'
