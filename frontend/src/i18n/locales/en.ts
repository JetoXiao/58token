export default {
  ...
  // Setup Wizard
  setup: {
    title: '58TokenVip Setup',
    description: 'Configure your 58TokenVip instance',
    database: {
  ...
  helpCenter: {
    ...
    description: 'Read setup guides for Codex, Claude Code, OpenClaw, Hermes, and other clients.',
    ...
    faq: 'FAQ',
    faqDescription: 'Find quick answers about setup, API keys, and client integrations.',
    faqSearchPlaceholder: 'Search questions, answers, or tags',
    noFaqResults: 'No matching questions',
    downloading: 'Downloading',
    previewImage: 'Preview image',
    openImagePreview: 'Open image preview',
    fitToWindow: 'Zoom image',
    actualSize: 'Actual size',
    downloadImage: 'Download image',
    downloadFailed: 'Failed to download attachment',
    disabledTitle: 'Help Center is unavailable',
    disabledDescription: 'Please check back later.',
    emptyTitle: 'No guides published',
    emptyDescription: 'Once an admin publishes guides, they will appear here.',
    failedToLoad: 'Failed to load Help Center',
    keyPrompt: {
      defaultTitle: 'API key created',
      defaultDescription: 'You can open the Help Center to connect this key to Codex, Claude Code, and other clients.',
      primary: 'Open Help Center',
      dismiss: 'Do not show this prompt again',
    },
  },
  ...
  auth: {
    ...
    emailSuffixAllowedHint: 'Registration only supports {suffixes} email addresses',
  ...
  keys: {
    ...
    groupLocked: 'This group is locked',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
    ...
    testModal: {
      ...
      description: 'Send a tiny request with the generated API key to verify that this key can connect to the selected model.',
      selectModel: 'Select test model',
      ready: 'Ready. Click "Start Test" to send a small hi request.',
      starting: 'Starting test for key: {name}',
      groupLine: 'Bound group: {group}',
      connected: 'Gateway accepted the request.',
      ...
      outputCopied: 'Test output copied',
  ...
  usage: {
    ...
    groupMultiplier: 'Group rate',
    standardSubtotal: 'Standard subtotal',
    otherBillingItems: 'Other billed items',
    accountBillingProcess: 'Account Billing Process',
    billingReferenceNote: 'For reference only. Actual deduction is authoritative.',
  ...
  downloads: {
    ...
    subtitle: 'Get clients, desktop tools, and companion resources for 58TokenVip.',
    catalogTitle: 'Available resources',
    catalogDescription: 'Choose a version to generate a secure download link.',
    download: 'Download',
    downloading: 'Preparing',
    retry: 'Reload',
    noResources: 'No resources are available yet',
    loadFailed: 'Unable to load resources. Please try again later.',
    downloadFailed: 'The download is temporarily unavailable. Please try again later.',
    version: 'Version',
    platform: 'Platform',
    size: 'Size',
    updated: 'Uploaded',
    downloads: 'Downloads',
    checksum: 'SHA-256',
    protectionTitle: 'Protected downloads',
    protectionDescription: 'Each download is rate-limited and served from private object storage with a short-lived authorization.',
  },
  ...
  affiliate: {
    ...
    usage: {
      pageTitle: 'Affiliate Usage',
      pageDescription: 'View usage, recharge, and commission details for your invited users',
      loadFailed: 'Failed to load affiliate usage',
      summaryInvitees: 'Invited users',
      summaryRequests: 'Range requests',
      summaryRecharge: 'Range recharge',
      summaryRebate: 'Range cashback due',
      summarySettled: 'Range paid cashback',
      summaryPending: 'Range pending cashback',
      searchPlaceholder: 'Search invited user email, username, or ID',
      invitee: 'Invited user',
      requests: 'Requests',
      totalTokens: 'Total tokens',
      actualCost: 'Actual spend',
      rechargeAmount: 'Recharge',
      rebateAmount: 'Cashback due',
      details: 'Details',
      detailsTitle: 'Cashback details',
      source: 'Source',
      group: 'Group',
      profitDetailAmount: 'Spend / package',
      profitRate: 'Profit rate',
      subscriptionSource: 'Subscription plan',
      settlementRecordsButton: 'Paid cashback history',
      settlementRecordsTitle: 'Paid cashback history',
      settlementRecordSearch: 'Search note',
      settlementRecordsLoadFailed: 'Failed to load paid cashback history',
      settlementAmount: 'Paid cashback',
      settlementDate: 'Paid date',
      settlementCreatedAt: 'Recorded at',
      settlementNote: 'Note'
    },
    stats: {
  ...
  redeem: {
    ...
    trialCardLabel: 'Trial Card',
    trialCardPlaceholder: 'Enter your trial card code',
    trialCardHint: 'Trial quota can only be used on admin-selected groups',
    trialCardButton: 'Redeem Trial Card',
    trialCardSuccess: 'Trial card redeemed',
    trialCardRemaining: 'Available trial quota',
    trialCardAllowedGroups: 'Allowed groups',
    trialCardRedeemSuccess: 'Trial card redeemed successfully!',
    failedToRedeemTrialCard: 'Failed to redeem trial card. Please check the code and try again.',
    pleaseEnterTrialCode: 'Please enter a trial card code'
  },
  ...
  admin: {
    downloadResources: {
      ...
      description: 'Manage public downloads, private R2 storage, and download records.',
      eyebrow: 'DOWNLOAD DELIVERY',
      ...
      storageMissing: 'Not configured',
      storageTitle: 'R2 download storage',
      storageDescription: 'Files remain private and are delivered through short-lived signed links.',
      endpoint: 'S3 API endpoint',
      bucket: 'Bucket',
      accessKey: 'Access Key ID',
      secretKey: 'Secret Access Key',
      secretUnchanged: 'Leave blank to keep the current key',
      prefix: 'Object prefix',
      region: 'Region',
      forcePathStyle: 'Use path-style S3 addressing',
      corsTitle: 'Browser upload CORS policy',
      corsDescription: 'Paste this JSON into Cloudflare R2 bucket Settings > CORS Policy. Presigned URLs still require this policy for browser uploads.',
      copyCORS: 'Copy CORS JSON',
      corsCopied: 'CORS policy copied',
      testConnection: 'Test connection',
      testSuccess: 'R2 storage connection succeeded',
      testFailed: 'R2 storage connection failed. Check the endpoint, bucket, and access keys.',
      storageSaved: 'R2 storage configuration saved',
      resourceList: 'Download resources',
      resourceListDescription: 'Published resources appear on the public download page without sign-in.',
      resource: 'Resource',
      visibility: 'Status',
      published: 'Published',
      draft: 'Draft',
      ...
      resourceFormDescription: 'After upload, the object and file size are verified before saving.',
      slug: 'Unique identifier',
      slugAuto: 'Generated after selecting a file',
      versionAuto: 'Read from the installer when available',
      nameZh: 'Chinese name',
      nameEn: 'English name',
      ...
      file: 'Installer file',
      fileHint: 'Uploading fills in the object key and file name automatically.',
      metadataDetected: 'Detected automatically: {platform} / version {version}',
      metadataFallback: 'Basic details were filled from the file name. Add a version manually when applicable.',
      ...
      fileTooLarge: 'Files must not exceed 2 GB.',
      uploadFailed: 'Upload failed. Configure R2 bucket CORS using the policy shown below the storage settings.',
      uploadFailedStatus: 'R2 upload failed (HTTP {status}). Check storage permissions and CORS settings.',
      saveFailed: 'Unable to save resource. Confirm that the file upload completed.',
      deleteConfirm: 'Remove resource "{name}"? Its R2 object will remain intact.',
      downloadRecords: 'Download records',
      downloadRecordsDescription: 'Records authorized download requests with IP, source, and time.',
      requestedAt: 'Requested at',
      identity: 'User / IP',
      user: 'User',
      location: 'Location',
      lookup: 'Look up',
      lookupFailed: 'Unable to look up this IP address.',
      referrer: 'Referrer',
      noRecords: 'No download records yet',
    },
    visitorAnalytics: {
      title: 'Visitor Analytics',
      description: 'Track anonymous visits, channel attribution, and IP locations',
      eyebrow: 'CHANNEL ANALYTICS',
      heroTitle: 'Traffic sources and channel performance',
      heroDescription: 'Create dedicated links for Discord, Reddit, and other campaigns. See daily visits, IP addresses, timestamps, and landing pages without requiring registration.',
      privacyNote: 'IP addresses are personal data. Disclose their use in your privacy policy and retain them only as long as necessary.',
      refresh: 'Refresh',
      dateRange: 'Date range',
      ...
      trendTitle: 'Daily traffic trend',
      trendDescription: 'Bars show page views; dots show unique visitors.',
      noTrend: 'No traffic in this date range',
      channelPerformance: 'Channel performance',
      channelDescription: 'Each channel gets a dedicated ref link ready for campaign placement.',
      manageChannels: 'Manage channels',
      createChannel: 'New channel',
      editChannel: 'Edit channel',
      channelName: 'Channel name',
      channelCode: 'Channel code',
      destinationPath: 'Landing page',
      channelNotes: 'Notes',
      enabled: 'Enabled',
      disabled: 'Disabled',
      copyLink: 'Copy link',
      linkCopied: 'Campaign link copied',
      save: 'Save channel',
      cancel: 'Cancel',
      delete: 'Delete',
      deleteConfirm: 'Delete this channel? Historical visits will be retained.',
      direct: 'Direct',
      noChannels: 'No channel data yet. Create a campaign link to begin attribution.',
      visitRecords: 'Visit records',
      recordsDescription: 'Only administrators can view full IP addresses; anonymous visitors do not become user accounts.',
      searchPlaceholder: 'Search page or referrer',
      ...
      noRecords: 'No visit records',
      previous: 'Previous',
      next: 'Next',
      pageOf: 'Page {page} of {pages}, {total} records',
      ipLookup: 'IP location lookup',
      ipLookupDescription: 'Enter an IPv4 or IPv6 address. Results come from a third-party geolocation database and are cached for 7 days.',
      ipPlaceholder: 'For example, 8.8.8.8',
      lookupAction: 'Look up IP',
      country: 'Country or region',
      regionCity: 'Region / city',
      timezone: 'Timezone',
      coordinates: 'Coordinates',
      trackingSettings: 'Data and retention',
      trackingDescription: 'Disabling tracking stops new events; existing data is removed after the retention period.',
      retention: 'Retention days',
      days: '{count} days',
      saveSettings: 'Save settings',
      settingsSaved: 'Visitor analytics settings saved',
      channelSaved: 'Channel saved',
      channelDeleted: 'Channel deleted',
      requestFailed: 'Failed to load visitor analytics',
      operationFailed: 'Operation failed. Please try again.',
      codeHint: 'Use lowercase letters, numbers, hyphens, and underscores. Codes cannot be changed after creation.',
      destinationHint: 'An internal path such as /home or /available-channels.',
      sourceUnknown: 'No referrer',
      bot: 'Bot'
    },
    // Dashboard
    dashboard: {
      ...
      balanceDeductionTitle: 'Daily Balance Deductions',
      balanceDeductionDescription: 'Wallet deductions by day; bars are users and the line is the platform total (subscriptions excluded)',
      platformTotal: 'Platform total',
      otherUsers: 'Other users',
      userUsageHierarchyTitle: 'User Usage',
      userUsageHierarchyDescription: 'Ranked by tokens; expand a user and group to inspect model calls',
      user: 'User',
      usage: 'Usage',
    ...
    affiliates: {
      ...
      usage: {
        ...
        rebateAmount: 'Cashback',
        settledAmount: 'Paid Cashback',
        pendingAmount: 'Pending Cashback',
        settlementActions: 'Settlement',
        groupMembers: 'Members',
        showMembers: 'View {count}',
        unassignedGroup: 'Unassigned inviter',
        searchPlaceholder: 'Search email, username, user ID, or invite code',
        inviterFilter: 'Filter inviter',
        inviteeFilter: 'Filter invitee',
        assignButton: 'Manual Assign',
        assignTitle: 'Manually Assign Invitee',
        ...
        subscriptionSource: 'Subscription plan',
        settleButton: 'Record Payment',
        settlementRecordsButton: 'Settlement Records',
        settlementRecordsShort: 'Records',
        settlementTitle: 'Record Paid Cashback',
        settlementUser: 'Cashback User',
        settlementAmount: 'Paid Cashback Amount',
        settlementDate: 'Payment Date',
        settlementNote: 'Note',
        settlementNotePlaceholder: 'Payment method, transaction ID, or reconciliation note',
        settlementSubmit: 'Save Payment',
        settlementSuccess: 'Cashback record saved',
        settlementRecordsTitle: 'Settlement Records',
        settlementRecordsForUser: '{user} settlement records',
        settlementRecordSearch: 'Search user, note, or operator',
        settlementCreatedBy: 'Recorded By',
        settlementCreatedAt: 'Recorded At',
        settlementInvalidAmount: 'Enter a cashback amount greater than 0',
        settlementInvalidDate: 'Select a payment date'
      },
      overview: {
    ...
    accounts: {
      ...
      upstreamPricing: {
        ...
        groupHint: 'Select the group this API key belongs to upstream',
        dashboardTokenLabel: 'Upstream dashboard access token (optional)',
        dashboardTokenHint: 'With a dashboard token, read this user\'s effective override ratio; otherwise show the public base ratio',
        dashboardTokenEditHint: 'Leave empty to keep the existing token',
      ...
      usageWindow: {
        ...
        resetCredits: '{count} reset(s)',
        resetWeeklyQuota: 'Reset',
        proxyRequired: 'Assign a proxy IP to this account first',
    ...
    trialCards: {
      title: 'Trial Card Management',
      description: 'Configure free quota rules and manage trial cards',
      settingsTitle: 'Free Quota Rules',
      settingsDescription: 'Free quota from referral-code signup and trial cards can only be used on selected groups.',
      invitationEnabled: 'Enable referral signup free quota',
      invitationEnabledHint: 'When enabled, new users who register through an existing referral code receive the configured free quota.',
      invitationAmount: 'Referral signup quota',
      freeGroups: 'Free quota groups',
      noGroups: 'No groups available',
      showLockedGroups: 'Show locked groups',
      showLockedGroupsHint: 'Show locked groups when free users choose an API key group, while keeping them blocked.',
      transferOnPayment: 'Transfer free quota after payment',
      transferOnPaymentHint: 'After successful payment, convert remaining free quota to normal balance. When off, it remains restricted and is used first.',
      createTitle: 'Create Trial Card',
      editTitle: 'Edit Trial Card',
      code: 'Trial Code',
      amount: 'Amount',
      ...
      neverExpires: 'Never expires',
      expiryOneDay: 'Valid for 1 day',
      expiryThreeDays: 'Valid for 3 days',
      expirySevenDays: 'Valid for 7 days',
      groupsRequired: 'Select at least one allowed group',
      createSuccess: 'Trial card created',
      createFailed: 'Failed to create trial card',
      updateFailed: 'Failed to update trial card',
      deactivate: 'Deactivate trial card',
      deactivateSuccess: 'Trial card deactivated',
      deleteFailed: 'Failed to deactivate trial card',
      deleteConfirm: 'Deactivate trial card "{code}"? The record will be kept, but new redemptions will be blocked.',
      loadGroupsFailed: 'Failed to load groups',
      loadSettingsFailed: 'Failed to load free quota settings',
      loadCardsFailed: 'Failed to load trial cards',
      saveSettingsFailed: 'Failed to save free quota settings'
    },
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for 58TokenVip end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for 58TokenVip end-user login',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: '58TokenVip',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: '58TokenVip',
        useTls: 'Use TLS',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to 58TokenVip',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">58TokenVip is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of 58TokenVip, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to 58TokenVip',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the 58TokenVip AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    blessing: {
      ...
      description: 'Your payment is complete. Here is a wish for the road ahead.',
      accept: 'Keep this wish',
      closeLabel: 'Close this wish'
    },
    currentBalance: 'Current Balance',
    ...
    methodUnavailableHint: 'No payment rail is enabled yet. You can still review packages and crediting rules; the recharge button will become available after a rail is enabled.',
    ...
    rechargeHeroEyebrow: 'Balance recharge',
    rechargeHeroTitle: 'Pay in RMB, receive USD balance',
    rechargeHeroDescription: 'The recharge page presents 1 RMB as 1 USD balance credited, making it easy to preload API usage credits.',
    usdtExchangeRateTitle: 'RMB to USDT rate',
    ...
    noPackageSelected: 'Select a package or enter a recharge amount',
    subscriptionPlanTitle: 'Subscription plans',
    subscriptionPlanSubtitle: 'Pick a monthly plan with daily, weekly, and monthly caps for steady team usage.',
    subscriptionSummaryTitle: 'Subscription checkout',
    subscriptionTargetTitle: 'Subscription target',
    subscriptionTargetDesc: 'When paying with balance, you can activate a subscription for another team account. Leave it blank to activate your own account.',
    subscriptionTargetEmail: 'Search target user',
    subscriptionTargetPlaceholder: 'Leave blank for yourself, or search email / username',
    subscriptionTargetHint: 'The cost is deducted from your current account balance. Usage and entitlement belong to the target user.',
    subscriptionTargetSearching: 'Searching...',
    subscriptionTargetNoResults: 'No matching user',
    subscriptionTargetSelectRequired: 'Select a matched user, or clear the field to activate your current account.',
    subscriptionTargetSelectedHint: 'Selected: {email}. The cost is deducted from your current account balance.',
    subscriptionTargetSummary: 'Activate for',
    subscriptionTargetCurrentUser: 'Current account',
    subscriptionValidityLabel: 'Validity',
    noSubscriptionPlanSelected: 'Select a subscription plan',
    subscriptionRuleWorkday: 'Plans include daily, weekly, and monthly caps tuned for weekday-heavy usage.',
    ...
    errors: {
      ...
      TARGET_USER_NOT_FOUND: 'Target user was not found.',
      TARGET_USER_INACTIVE: 'Target user account is disabled.',
      TARGET_USER_MISMATCH: 'Target user email does not match the user ID.',
      BALANCE_SUBSCRIPTION_NOT_ALLOWED: 'Balance subscription purchase is not enabled for this account.',
    ...
    planCard: {
      ...
      restorePrice: 'Restores to',
      discountPercent: '{percent}% off',
      saveAmount: 'Save {amount}',
      dealHint: 'Originally {original}, now {price} to start.',
      limitedOffer: 'Limited-time offer',
      limitedOfferUntil: 'Offer ends {time}; then restores to {price}.',
      ...
      workdayFriendly: 'Workday-friendly quota',
      workdayFriendlyDesc: '{daily} per day and {weekly} per week, tuned for Monday-Friday usage.',
    },
    days: 'days',
    months: 'months',
    years: 'years',
    ...
    admin: {
      ...
      price: 'Price',
      limitedOffer: 'Limited-time offer',
      limitedOfferHint: 'Set a temporary lower price. Leave the price empty or 0 to disable the offer.',
      limitedOfferPrice: 'Offer Price',
      limitedOfferPricePlaceholder: 'e.g. 99',
      limitedOfferExpiresAt: 'Offer Ends At',
      limitedOfferActive: 'Limited offer',
      limitedOfferExpired: 'Offer expired',
      limitedOfferUntil: 'Until {time}',
      restorePrice: 'Restores to {price}',
      limitedOfferPriceMustBeLower: 'The offer price must be lower than the restored plan price.',
      limitedOfferExpiresRequired: 'Set an offer end time when using an offer price.',
      validityDays: 'Validity (days)',
  ...
  gateway: {
    ...
    partner: {
      ...
      title: 'Earn more by bringing builders to 58TokenVip.',
