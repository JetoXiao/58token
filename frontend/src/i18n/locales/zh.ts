export default {
  ...
  imageGeneration: {
    ...
    referenceImages: {
      ...
      action: '选择图片',
      remove: '移除参考图片',
      hint: '支持 PNG、JPG、WebP；当前模型最多 {count} 张，单张不超过 {fileSize}，合计不超过 {totalSize}。',
      errors: {
        count: '当前模型最多支持 {count} 张参考图片。',
        type: '“{name}”格式不支持，请上传 PNG、JPG 或 WebP。',
        fileSize: '“{name}”超过单张 {size} 的限制。',
        totalSize: '参考图片合计不能超过 {size}。'
      }
    },
    emptyKeys: {
      title: '暂无可生图的 API 密钥',
      description: '请创建或更新一个启用中的 OpenAI、Gemini 或 Antigravity API 密钥，并确保所在分组已允许生图。',
      action: '管理 API 密钥'
    },
    sizes: {
    ...
    templates: {
      typography: {
        title: '中文字体海报',
        description: '测试复杂排版、准确文字与材质表现。',
        prompt: '设计一张竖版电影节主视觉海报。画面中心是一座由半透明红色玻璃构成的未来剧院，雨夜霓虹倒影，电影级体积光与真实折射。必须清晰、准确地排版以下中文：主标题“光影之外”，副标题“未来影像实验季”，日期“10.18—10.27”，地点“上海·西岸艺术中心”。使用瑞士国际主义网格，主标题为醒目的现代黑体，所有文字不可乱码、不可增删，整体达到国际设计奖参赛作品水准。'
      },
      characterSheet: {
        title: '角色一致性设定',
        description: '同一角色跨视角、表情与动作保持一致。',
        prompt: '创建一张专业动画角色设定表：原创角色“岚”，25 岁亚洲女性机械工程师，银灰色短发，左眉有一道细疤，穿墨绿色功能夹克，胸前别着橙色圆形徽章。画面包含正面、侧面、背面全身视图，六种清晰表情，以及手持工具箱的动态姿势。每个分格必须保持五官、发型、服装结构、徽章位置和身体比例完全一致；纯浅灰背景，工作室概念设计稿风格，细节精确。'
      },
      cinematicProduct: {
        title: '电影级产品广告',
        description: '测试真实材质、微距细节和商业灯光。',
        prompt: '为一块无品牌的精密机械腕表制作电影级横版广告。腕表悬浮在被雨水打湿的黑色火山岩上，表壳为拉丝钛金属，蓝宝石镜面出现受控高光，表盘齿轮与刻度清晰可见；清晨冷雾从岩石间流过，左后方暖金色轮廓光与右侧冷蓝柔光形成对比。使用 100mm 微距镜头质感、浅景深、真实物理材质与高动态范围，右侧保留干净留白，禁止出现品牌、乱码或多余零件。'
      },
      technicalDiagram: {
        title: '精密科普信息图',
        description: '测试空间推理、结构关系与标签清晰度。',
        prompt: '绘制一张横版“海上风力发电如何工作”的博物馆级科普信息图。左侧展示海上风机的剖面结构，中间用清晰箭头连接叶片、齿轮箱、发电机、海底电缆，右侧展示电力进入城市电网的流程。使用蓝绿与亮黄色的克制配色、等距技术插画、统一线宽和编号系统；中文标签仅包含“叶片、齿轮箱、发电机、海底电缆、变电站、城市电网”，文字必须清晰准确，因果方向不能出错。'
      },
      productComposite: {
        title: '多图商品合成',
        description: '把商品、配件和场景融合成统一广告画面。',
        prompt: '以第 1 张图的商品为绝对主体，完整保留它的造型、颜色、Logo、标签文字和材质细节；从第 2、3 张参考图中提取配件与环境元素，合成为一张真实的高端商业广告。统一透视、光源方向、阴影软硬和色温，让所有物体像在同一次摄影中拍摄；修复抠图边缘与反射关系，但不要重新设计商品，不得改变任何包装文字。'
      },
      characterEdit: {
        title: '人物跨场景一致性',
        description: '保留身份特征，只改变服装、动作和环境。',
        prompt: '严格保留参考人物的身份特征：脸型、五官比例、肤色、发型和年龄感都不能改变。将人物置于 1960 年代东京雨夜街头，穿剪裁准确的复古风衣，手持透明雨伞，从霓虹招牌前回头看向镜头。采用 35mm 电影胶片质感、自然皮肤纹理、真实雨滴与路面反光；不要美化成不同的人，不要改变面部结构。'
      },
      sketchRender: {
        title: '草图转成品',
        description: '把线稿结构转成可落地的真实设计。',
        prompt: '把参考草图转换为可制造的高端桌面音箱产品渲染。严格遵循草图中的轮廓、按键位置、开孔比例和结构关系，不增加不存在的部件；材质改为阳极氧化铝机身、深灰织物网罩和磨砂旋钮。输出一张三分之四视角主图，并在背景中以浅色工程线稿展示侧视轮廓，真实棚拍灯光，工业设计作品集水准。'
      },
      multiImage: {
        title: '多参考图世界融合',
        description: '验证多主体理解、关系推理与风格统一。',
        prompt: '将所有参考图中的主要对象组合进同一个连贯场景：它们正在一座漂浮于云海之上的玻璃温室中共同准备晚餐。每个对象都必须保留可识别的外观、颜色、纹理和比例特征，并安排自然互动而不是简单并排。统一为写实电影画面，黄金时刻逆光，玻璃折射、植物阴影与桌面接触影准确，构图有明确前中后景，不复制对象，不遗漏主体。'
      }
    },
    actions: {
      generating: '生成中...',
  ...
  // Setup Wizard
  setup: {
    title: '58TokenVip 安装向导',
    description: '配置您的 58TokenVip 实例',
    database: {
      title: '数据库配置',
  ...
  helpCenter: {
    title: '帮助中心',
    eyebrow: '客户端配置',
    description: '查看 Codex、Claude Code、OpenClaw、Hermes 等客户端接入教程。',
    goToKeys: '前往 API 密钥',
    clients: '客户端',
    ...
    attachments: '附件',
    faq: '常见问题',
    faqDescription: '快速查找新手配置、API 密钥和客户端接入相关问题。',
    faqSearchPlaceholder: '搜索问题、答案或标签',
    noFaqResults: '没有匹配的问题',
    downloading: '下载中',
    previewImage: '查看大图',
    ...
    disabledTitle: '帮助中心暂未开放',
    disabledDescription: '请稍后再试。',
    emptyTitle: '暂无已发布教程',
    emptyDescription: '管理员发布教程后会显示在这里。',
    failedToLoad: '帮助中心加载失败',
    keyPrompt: {
      defaultTitle: 'API 密钥已创建',
      defaultDescription: '你可以打开帮助中心，将这个 Key 接入 Codex、Claude Code 等客户端。',
      primary: '打开帮助中心',
      dismiss: '不再显示这个提示',
    },
  },
  ...
  auth: {
    ...
    emailSuffixAllowedHint: '仅支持 {suffixes} 邮箱注册',
  ...
  keys: {
    ...
    testModal: {
      title: '测试密钥连接',
      description: '使用生成的 API 密钥发送一条极小测试请求，验证该密钥是否能连通所选模型。',
      selectModel: '选择测试模型',
      ready: '准备测试。点击“开始测试”发送一条 hi 测试请求。',
      starting: '开始测试密钥：{name}',
      groupLine: '绑定分组：{group}',
      connected: '网关已接受请求。',
  ...
  usage: {
    ...
    completionTokens: '补全',
    cacheCreation: '缓存创建',
    imageOutputTokens: '图片输出',
    groupMultiplier: '分组倍率',
    standardSubtotal: '标准小计',
    otherBillingItems: '其他计费项',
    accountBillingProcess: '账号计费过程',
    billingReferenceNote: '仅供参考，以实际扣费为准',
    requestCount: '请求数',
  ...
  downloads: {
    title: '资源下载',
    eyebrow: '客户端下载',
    subtitle: '获取适用于 58TokenVip 的客户端、桌面工具与配套资源。',
    catalogTitle: '可用资源',
    catalogDescription: '选择需要的版本，下载链接会在验证后安全生成。',
    download: '下载',
    downloading: '正在准备',
    retry: '重新加载',
    noResources: '暂时没有可下载的资源',
    loadFailed: '资源列表加载失败，请稍后重试。',
    downloadFailed: '下载暂时不可用，请稍后再试。',
    version: '版本',
    platform: '平台',
    size: '大小',
    updated: '上传时间',
    downloads: '下载次数',
    checksum: 'SHA-256',
    protectionTitle: '安全下载',
    protectionDescription: '每次下载均经过限流保护，安装包由私有对象存储按短时授权提供。',
  },
  ...
  affiliate: {
    ...
    linkCopied: '邀请链接已复制',
    sharePoster: '生成分享图',
    generatingPoster: '生成中...',
    posterPreviewTitle: '邀请分享图',
    posterAlt: '邀请分享图',
    posterPreviewHint: '二维码已绑定你的邀请链接，下载后可直接发给好友或分享到微信。',
    downloadPoster: '下载图片',
    posterGenerated: '邀请分享图已生成',
    posterFailed: '生成分享图失败，请稍后重试',
    loadFailed: '加载邀请返利数据失败',
    transferFailed: '转入余额失败',
    usage: {
      pageTitle: '合伙人用量',
      pageDescription: '查看自己邀请用户的用量、充值和返现明细',
      loadFailed: '加载合伙人用量失败',
      summaryInvitees: '邀请用户',
      summaryRequests: '区间请求数',
      summaryRecharge: '区间充值',
      summaryRebate: '区间应返现',
      summarySettled: '区间已返现',
      summaryPending: '区间待返现',
      searchPlaceholder: '搜索被邀请用户邮箱、用户名或 ID',
      invitee: '被邀请用户',
      requests: '请求数',
      totalTokens: '总 Token',
      actualCost: '实际消费',
      ...
      source: '来源',
      group: '分组',
      profitDetailAmount: '消费 / 套餐金额',
      profitRate: '利润率',
      subscriptionSource: '订阅套餐',
      settlementRecordsButton: '已返现历史',
      settlementRecordsTitle: '已返现历史',
      settlementRecordSearch: '搜索备注',
      settlementRecordsLoadFailed: '加载已返现历史失败',
      settlementAmount: '已返现',
      settlementDate: '返现日期',
      settlementCreatedAt: '记录时间',
      settlementNote: '备注'
    },
    stats: {
      partnerLevel: '合伙人等级',
  ...
  redeem: {
    ...
    trialCardLabel: '体验卡',
    trialCardPlaceholder: '请输入体验卡兑换码',
    trialCardHint: '体验卡额度仅可用于管理员指定的分组',
    trialCardButton: '兑换体验卡',
    trialCardSuccess: '体验卡兑换成功',
    trialCardRemaining: '可用免费额度',
    trialCardAllowedGroups: '可用分组',
    trialCardRedeemSuccess: '体验卡兑换成功！',
    failedToRedeemTrialCard: '体验卡兑换失败，请检查兑换码后重试。',
    pleaseEnterTrialCode: '请输入体验卡兑换码'
  },
  ...
  admin: {
    downloadResources: {
      title: '资源下载管理',
      description: '管理公开下载资源、R2 私有存储和下载记录。',
      eyebrow: 'DOWNLOAD DELIVERY',
      addResource: '添加资源',
      totalResources: '资源总数',
      publishedResources: '已发布',
      totalDownloads: '累计下载',
      storageStatus: '存储状态',
      storageReady: '已配置',
      storageMissing: '未配置',
      storageTitle: 'R2 下载存储',
      storageDescription: '文件保持私有，仅通过短时签名链接下载。',
      endpoint: 'S3 API 端点',
      bucket: '存储桶',
      ...
      corsTitle: '浏览器上传 CORS 配置',
      corsDescription: '请在 Cloudflare R2 存储桶的设置 > CORS 策略中粘贴以下 JSON。预签名地址仍需要这项配置才能从浏览器上传。',
      copyCORS: '复制 CORS JSON',
      corsCopied: 'CORS 配置已复制',
      testConnection: '测试连接',
      testSuccess: 'R2 存储连接成功',
      testFailed: 'R2 存储连接失败，请检查端点、存储桶和访问密钥。',
      storageSaved: 'R2 存储配置已保存',
      resourceList: '下载资源',
      resourceListDescription: '发布后的资源会在未登录的资源下载页面展示。',
      resource: '资源',
      visibility: '状态',
      published: '已发布',
      draft: '草稿',
      noResources: '还没有资源',
      editResource: '编辑资源',
      resourceFormDescription: '上传文件后，系统会验证对象存在和文件大小。',
      slug: '唯一标识',
      slugAuto: '上传文件后自动生成',
      versionAuto: '优先从安装包自动读取',
      nameZh: '中文名称',
      nameEn: '英文名称',
      descriptionZh: '中文简介',
      descriptionEn: '英文简介',
      sortOrder: '排序权重',
      file: '安装包文件',
      fileHint: '上传后将自动写入对象键和文件名。',
      metadataDetected: '已自动识别：{platform} / 版本 {version}',
      metadataFallback: '已根据文件名自动填写基础信息；如资源有版本号，可手动补充。',
      uploadFile: '上传文件',
      uploading: '上传中',
      uploadProgress: '上传进度',
      cancelUpload: '取消上传',
      ...
      fileName: '下载文件名',
      contentType: '内容类型',
      fileTooLarge: '文件不能超过 2 GB。',
      uploadFailed: '文件上传失败，请先按存储配置下方的说明设置 R2 Bucket CORS。',
      uploadFailedStatus: 'R2 上传失败（HTTP {status}），请检查存储权限与 CORS 配置。',
      saveFailed: '资源保存失败，请确认文件已完成上传。',
      deleteConfirm: '确认移除资源“{name}”？不会删除 R2 中的原文件。',
      downloadRecords: '下载记录',
      downloadRecordsDescription: '记录已生成下载授权的访问 IP、来源和时间。',
      requestedAt: '请求时间',
      identity: '用户 / IP',
      user: '用户',
      location: '归属地',
      lookup: '查询归属地',
      lookupFailed: 'IP 归属地查询失败，请稍后重试。',
      referrer: '来源页面',
      noRecords: '还没有下载记录',
    },
    visitorAnalytics: {
      title: '访问分析',
      description: '统计匿名访问、渠道归因与访客 IP 属地',
      eyebrow: '渠道访问统计',
      heroTitle: '访问来源与渠道表现',
      heroDescription: '为 Discord、Reddit 等投放渠道创建专属链接，按北京时间查看访问人数、IP、访问时间与落地页面。访客无需注册即可计入统计。',
      privacyNote: 'IP 地址属于个人信息。请在隐私政策中披露用途，并仅保留业务所需的最短时间。',
      refresh: '刷新数据',
      dateRange: '统计日期',
      pageViews: '页面访问量',
      uniqueVisitors: '独立访客',
      ...
      activeChannels: '有效渠道',
      trendTitle: '每日访问趋势',
      trendDescription: '柱形显示访问量，圆点表示独立访客。',
      noTrend: '当前时间范围内暂无访问数据',
      channelPerformance: '渠道表现',
      channelDescription: '每个渠道生成独立 ref 链接，复制后直接用于对应平台投放。',
      manageChannels: '管理渠道',
      createChannel: '新建渠道',
      editChannel: '编辑渠道',
      channelName: '渠道名称',
      channelCode: '渠道代码',
      destinationPath: '落地页面',
      channelNotes: '备注',
      enabled: '启用',
      disabled: '停用',
      copyLink: '复制链接',
      ...
      cancel: '取消',
      delete: '删除',
      deleteConfirm: '确认删除这个渠道？历史访问记录仍会保留。',
      direct: '直接访问',
      noChannels: '暂无渠道数据，先创建一个渠道链接开始归因。',
      visitRecords: '访问明细',
      recordsDescription: '仅管理员可查看完整 IP；匿名访客不会因此自动创建用户账户。',
      searchPlaceholder: '搜索页面或来源网址',
      allChannels: '全部渠道',
      time: '访问时间',
      channel: '渠道',
      ip: 'IP 地址',
      ...
      ipLookup: 'IP 属地查询',
      ipLookupDescription: '输入 IPv4 或 IPv6 地址，结果来自第三方地理数据库并缓存 7 天。',
      ...
      timezone: '时区',
      coordinates: '坐标',
      trackingSettings: '数据与保留策略',
      trackingDescription: '关闭后将停止记录新的访问；已有数据在保留期到期后自动清理。',
      retention: '日志保留天数',
      days: '{count} 天',
      saveSettings: '保存设置',
      settingsSaved: '访问统计设置已保存',
      channelSaved: '渠道已保存',
      channelDeleted: '渠道已删除',
      requestFailed: '加载访问统计失败',
      operationFailed: '操作失败，请稍后重试',
      codeHint: '仅支持小写字母、数字、短横线和下划线；创建后不可修改，避免已投放链接失效。',
      destinationHint: '站内路径，例如 /home 或 /available-channels。',
      sourceUnknown: '无来源',
      bot: '机器人'
    },
    // Dashboard
    dashboard: {
      ...
      balanceDeductionTitle: '每日余额扣费',
      balanceDeductionDescription: '按钱包余额扣除统计，柱状为用户，折线为平台合计（订阅不计入）',
      platformTotal: '平台合计',
      otherUsers: '其他用户',
      userUsageHierarchyTitle: '用户使用情况',
      userUsageHierarchyDescription: '按 Token 用量排序，展开用户和分组可查看模型调用明细',
      user: '用户',
      usage: '用量',
    ...
    affiliates: {
      ...
      usage: {
        ...
        settledAmount: '已返现',
        pendingAmount: '待返现',
        settlementActions: '结算',
        groupMembers: '成员明细',
        showMembers: '查看 {count} 人',
        unassignedGroup: '未分配邀请人',
        searchPlaceholder: '搜索邮箱、用户名、用户 ID 或邀请码',
        inviterFilter: '筛选邀请人',
        inviteeFilter: '筛选被邀请人',
        assignButton: '手动分配',
        assignTitle: '手动分配邀请关系',
        assignSubmit: '保存分配',
        ...
        subscriptionSource: '订阅套餐',
        settleButton: '登记返现',
        settlementRecordsButton: '结算记录',
        settlementRecordsShort: '记录',
        settlementTitle: '登记已返现',
        settlementUser: '返现用户',
        settlementAmount: '已返现金额',
        settlementDate: '返现日期',
        settlementNote: '备注',
        settlementNotePlaceholder: '填写打款方式、流水号或对接说明',
        settlementSubmit: '保存返现',
        settlementSuccess: '返现记录已保存',
        settlementRecordsTitle: '结算记录',
        settlementRecordsForUser: '{user} 的结算记录',
        settlementRecordSearch: '搜索用户、备注或操作人',
        settlementCreatedBy: '登记人',
        settlementCreatedAt: '登记时间',
        settlementInvalidAmount: '请输入大于 0 的返现金额',
        settlementInvalidDate: '请选择返现日期'
      },
      overview: {
        title: '用户返利概览',
        affCode: '邀请码',
    ...
    users: {
      ...
      form: {
        ...
        roleLabel: '角色',
        selectRole: '选择角色',
        readonlyAdminHint: '只读管理员在后台只能查看已授权菜单；用户侧公开功能可正常操作。',
        superAdminProtectedHint: '超级管理员拥有完整权限，不能在这里降级。',
    ...
    accounts: {
      ...
      upstreamPricing: {
        ...
        groupLabel: '上游分组',
        loadGroups: '加载分组',
        groupHint: '请选择这把 Key 在上游所属的分组',
        dashboardTokenLabel: '上游控制台访问令牌（可选）',
        dashboardTokenHint: '填写上游控制台令牌后，读取该用户的实际覆盖倍率；否则显示公开基础倍率',
        dashboardTokenEditHint: '留空保持已有令牌不变',
      ...
      usageWindow: {
        ...
        activeQuery: '查询',
        expiresAt: '到期 {time}',
        resetCredits: '次数 {count}',
        resetWeeklyQuota: '重置',
        proxyRequired: '请先给该账号绑定代理 IP',
    ...
    trialCards: {
      title: '体验卡管理',
      description: '配置免费额度规则，创建和管理体验卡',
      settingsTitle: '免费额度规则',
      settingsDescription: '邀请返利码注册与体验卡兑换产生的免费额度仅能用于所选分组。',
      invitationEnabled: '启用邀请注册赠送免费额度',
      invitationEnabledHint: '开启后，用户通过现有邀请返利码注册成功时获得配置的免费额度。',
      invitationAmount: '邀请注册赠送额度',
      freeGroups: '免费额度可用分组',
      noGroups: '暂无可选分组',
      showLockedGroups: '未解锁分组可见',
      showLockedGroupsHint: '免费用户选择 API 密钥分组时展示未解锁分组，但仍阻止选择。',
      transferOnPayment: '充值后追加原免费额度',
      transferOnPaymentHint: '支付成功后将剩余免费额度转为普通余额；关闭时仍只在受限分组优先消费。',
      createTitle: '创建体验卡',
      editTitle: '编辑体验卡',
      code: '体验码',
      amount: '额度',
      maxRedemptions: '总可兑换次数',
      perUserLimit: '每用户次数',
      allowedGroups: '可用分组',
      expiresAt: '过期时间',
      createdAt: '创建时间',
      notes: '备注',
      redemptions: '兑换进度',
      remainingRedemptions: '剩余次数',
      neverExpires: '永不过期',
      expiryOneDay: '1 天有效',
      expiryThreeDays: '3 天有效',
      expirySevenDays: '7 天有效',
      groupsRequired: '请选择至少一个可用分组',
      createSuccess: '体验卡创建成功',
      createFailed: '体验卡创建失败',
      updateFailed: '体验卡更新失败',
      deactivate: '使体验卡失效',
      deactivateSuccess: '体验卡已失效',
      deleteFailed: '体验卡失效失败',
      deleteConfirm: '确定让体验卡「{code}」失效吗？记录会保留，未兑换用户将无法再使用。',
      loadGroupsFailed: '加载分组失败',
      loadSettingsFailed: '加载免费额度规则失败',
      loadCardsFailed: '加载体验卡列表失败',
      saveSettingsFailed: '保存免费额度规则失败'
    },
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 58TokenVip 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 58TokenVip 用户登录',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 58TokenVip',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">58TokenVip 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 58TokenVip 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 58TokenVip',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 58TokenVip AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  payment: {
    ...
    methodUnavailableHint: '当前还没有启用可用的支付通道，所以可以先查看充值套餐和到账规则，正式充值按钮会在通道开启后可用。',
    ...
    rechargeHeroEyebrow: '余额充值',
    rechargeHeroTitle: '用人民币充值，按美元余额到账',
    rechargeHeroDescription: '充值页面按 1 RMB 到账 1 USD 余额展示，适合提前储备 API 调用额度。',
    usdtExchangeRateTitle: '人民币兑 USDT 汇率',
    ...
    noPackageSelected: '请选择套餐或输入充值金额',
    subscriptionPlanTitle: '订阅套餐',
    subscriptionPlanSubtitle: '选择包月套餐，按日、周、月分别限制额度，适合团队持续使用。',
    subscriptionSummaryTitle: '订阅确认',
    subscriptionTargetTitle: '开通对象',
    subscriptionTargetDesc: '使用余额支付时，可为团队中的其他账号开通订阅；不填写则为当前账号开通。',
    subscriptionTargetEmail: '搜索目标用户',
    subscriptionTargetPlaceholder: '留空为自己开通，或输入邮箱/用户名关键词',
    subscriptionTargetHint: '费用从当前登录账号余额扣除，订阅权益和用量记录归目标用户。',
    subscriptionTargetSearching: '搜索中...',
    subscriptionTargetNoResults: '未找到匹配用户',
    subscriptionTargetSelectRequired: '请从匹配结果中选择一个用户；清空则为当前账号开通。',
    subscriptionTargetSelectedHint: '已选择：{email}。费用从当前登录账号余额扣除。',
    subscriptionTargetSummary: '开通给',
    subscriptionTargetCurrentUser: '当前账号',
    subscriptionValidityLabel: '有效期',
    noSubscriptionPlanSelected: '请选择一个订阅套餐',
    subscriptionRuleWorkday: '套餐包含每日、每周、每月额度，工作日集中使用更友好。',
    ...
    errors: {
      ...
      TARGET_USER_INACTIVE: '目标用户账号已被禁用',
      TARGET_USER_MISMATCH: '目标用户邮箱与用户 ID 不匹配',
      BALANCE_SUBSCRIPTION_NOT_ALLOWED: '当前账号未开放余额购买订阅权限',
    ...
    planCard: {
      ...
      originalPrice: '原价',
      restorePrice: '恢复价',
      discountPercent: '{percent}% 折扣',
      saveAmount: '立省 {amount}',
      dealHint: '原价 {original}，现在只需 {price} 开通。',
      limitedOffer: '限时优惠',
      limitedOfferUntil: '限时优惠至 {time}，结束后恢复 {price}。',
      validFor: '有效 {duration}',
      durationDays: '{count} 天',
      durationWeeks: '{count} 周',
      durationMonths: '{count} 个月',
      durationYears: '{count} 年',
      workdayFriendly: '工作日友好额度',
      workdayFriendlyDesc: '每日 {daily}，每周 {weekly}，适合周一到周五集中使用。',
    },
    days: '天',
    months: '个月',
    years: '年',
    ...
    admin: {
      ...
      price: '价格',
      limitedOffer: '限时优惠',
      limitedOfferHint: '设置一个临时优惠价，优惠价留空或填 0 表示关闭优惠。',
      limitedOfferPrice: '优惠价',
      limitedOfferPricePlaceholder: '例如 99',
      limitedOfferExpiresAt: '优惠截止时间',
      limitedOfferActive: '限时优惠',
      limitedOfferExpired: '优惠已过期',
      limitedOfferUntil: '至 {time}',
      restorePrice: '恢复 {price}',
      limitedOfferPriceMustBeLower: '优惠价必须低于套餐恢复价。',
      limitedOfferExpiresRequired: '设置优惠价时需要填写优惠截止时间。',
      validityDays: '有效期（天）',
      validityUnit: '有效期单位',
      sortOrder: '排序',
      forSale: '上架状态',
  ...
  gateway: {
    ...
    partner: {
      pageTitle: '合伙人计划',
      eyebrow: '合伙人计划',
      title: '把开发者带来 58TokenVip，获得更高返利。',
