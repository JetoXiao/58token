...
const labelClass = computed(() => {
  const colors = {
    ...
    emerald: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300',
    purple: 'bg-accent-100 text-accent-700 dark:bg-accent-900/40 dark:text-accent-300',
    amber: 'bg-accent-50 text-accent-700 dark:bg-accent-900/40 dark:text-accent-300'
  }
