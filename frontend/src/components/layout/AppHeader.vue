    ...
    <div class="flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <a
          ...
          class="flex items-center gap-1.5 rounded-xl border border-transparent px-2.5 py-1.5 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-dark-300 dark:hover:border-white/10 dark:hover:bg-white/[0.06] dark:hover:text-white"
        >
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            class="flex items-center gap-2 rounded-2xl border border-transparent p-1.5 transition-colors hover:bg-gray-100 dark:hover:border-white/10 dark:hover:bg-white/[0.06]"
            aria-label="User Menu"
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-cyan-400 to-violet-500 text-sm font-medium text-white shadow-sm shadow-cyan-500/20">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
...
const showOnboardingButton = computed(() => {
  return !authStore.isSimpleMode && authStore.isSuperAdmin
})
