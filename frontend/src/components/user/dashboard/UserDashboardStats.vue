<template>
  ...
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
    ...
    <div v-if="!isSimple" class="card group overflow-hidden p-5 card-hover">
      <div class="flex items-center gap-3">
        <div class="rounded-2xl bg-emerald-100 p-3 ring-1 ring-emerald-500/10 dark:bg-emerald-400/10">
        ...
        <div>
          ...
          <p class="text-2xl font-semibold tracking-tight text-emerald-600 dark:text-emerald-300">${{ formatBalance(displayBalance ?? balance) }}</p>
    ...
    <div class="card group overflow-hidden p-5 card-hover">
      <div class="flex items-center gap-3">
        <div class="rounded-2xl bg-blue-100 p-3 ring-1 ring-blue-500/10 dark:bg-blue-400/10">
    ...
    <div class="card group overflow-hidden p-5 card-hover">
      <div class="flex items-center gap-3">
        <div class="rounded-2xl bg-green-100 p-3 ring-1 ring-green-500/10 dark:bg-green-400/10">
    ...
    <div class="card group overflow-hidden p-5 card-hover">
      <div class="flex items-center gap-3">
        <div class="rounded-2xl bg-purple-100 p-3 ring-1 ring-purple-500/10 dark:bg-purple-400/10">
  ...
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
    ...
    <div class="card p-5 card-hover">
      <div class="flex items-center gap-3">
        <div class="rounded-2xl bg-amber-100 p-3 ring-1 ring-amber-500/10 dark:bg-amber-400/10">
    ...
    <div class="card p-5 card-hover">
      <div class="flex items-center gap-3">
        <div class="rounded-2xl bg-violet-100 p-3 ring-1 ring-violet-500/10 dark:bg-violet-400/10">
    ...
    <div class="card p-5 card-hover">
      <div class="flex items-center gap-3">
        <div class="rounded-2xl bg-rose-100 p-3 ring-1 ring-rose-500/10 dark:bg-rose-400/10">
