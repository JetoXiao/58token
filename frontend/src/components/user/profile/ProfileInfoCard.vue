          ...
          <div class="min-w-0 flex-1 space-y-5">
            <div class="space-y-3">
              <div class="flex flex-wrap items-center gap-2">
                ...
                <span :class="['badge', user?.role === 'admin' || user?.role === 'sub_admin' ? 'badge-primary' : 'badge-gray']">
                  {{ user?.role === 'admin' ? t('profile.superAdministrator') : user?.role === 'sub_admin' ? t('profile.administrator') : t('profile.user') }}
                </span>
                <span
