...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: '/partners',
    name: 'PartnerProgram',
    component: () => import('@/views/public/PartnerProgramView.vue'),
    meta: {
      requiresAuth: false,
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_channel_pricing',
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_channel_monitor',
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_subscriptions',
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_announcements',
      title: 'Announcements',
  ...
  {
    path: '/admin/trial-cards',
    name: 'AdminTrialCards',
    component: () => import('@/views/admin/TrialCardsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_redeem',
      title: 'Trial Cards',
      titleKey: 'admin.trialCards.title',
      descriptionKey: 'admin.trialCards.description'
    }
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_promo_codes',
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_risk_control',
      title: 'Risk Control',
  ...
  },
  {
    ...
    redirect: '/admin/affiliates/usage'
  },
  {
    path: '/admin/affiliates/usage',
    name: 'AdminAffiliateUsage',
    component: () => import('@/views/admin/affiliates/AdminAffiliateUsageView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_affiliate_usage',
      title: 'Affiliate Usage',
      titleKey: 'nav.affiliateUsage',
      descriptionKey: 'admin.affiliates.usageDescription'
    }
  },
  {
    path: '/admin/affiliates/applications',
    name: 'AdminAffiliateApplications',
    component: () => import('@/views/admin/affiliates/AdminAffiliateApplicationsView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_affiliate_applications',
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_affiliate_invites',
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_affiliate_rebates',
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_affiliate_transfers',
  ...
  // ==================== Payment Admin Routes ====================
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_order_dashboard',
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      adminMenuKey: 'admin_order_plans',
