# 58Token Deployment Files

This directory contains files for deploying 58Token on Linux servers.
...
58Token supports three methods to connect to Gemini:
...
58Token supports TLS fingerprint simulation to make requests appear as if they come from the official Claude CLI (Node.js client).
